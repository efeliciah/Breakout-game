...
public class BreakoutGUI extends Application implements IEventHandler {
    ...
    private void keyPressed(KeyEvent event) {
        ...
        switch (kc) {
            case LEFT:
                breakout.setPaddleSpeed(-PADDLE_SPEED);
                break;
            case RIGHT:
                breakout.setPaddleSpeed(PADDLE_SPEED);
                break;
    ...
    private void newGame() {
        ...
        breakout = new Breakout(bricks, walls);
    ...
    private List<Wall> getWalls() {
        Wall left = new Wall(0, 0, 0, 400, Wall.Dir.VERTICAL);             // TODO
        Wall top = new Wall(0, 0, 400, 0, Wall.Dir.HORIZONTAL);           //TODO
        Wall right = new Wall(400, 0, 0, 400, Wall.Dir.VERTICAL);               //TODO
